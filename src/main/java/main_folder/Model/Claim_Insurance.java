...
public class Claim_Insurance {
    ...
    public Claim_Insurance(Integer id, Date claim_Date, Date exam_Date, Double claim_amount, String insured_Person, String status, String documents, String receiver_Banking_Infor) {
        this.id = id;
